...
adb shell "echo 1209600 > /sys/devices/system/cpu/cpu7/cpufreq/scaling_max_freq"
adb shell "echo 1209600 > /sys/devices/system/cpu/cpu7/cpufreq/scaling_min_freq"
