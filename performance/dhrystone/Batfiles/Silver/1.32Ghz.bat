...
adb shell "echo 1324800 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq"
adb shell "echo 1324800 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq"
