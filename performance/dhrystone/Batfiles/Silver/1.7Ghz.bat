...
adb shell "echo 1708800 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq"
adb shell "echo 1708800 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq"
